...
if __name__ == "__main__":
    ...
    for scene in tqdm(sorted(os.listdir(args.mask_dir_path))):
        try:
            ...
            for file in os.listdir(os.path.join(args.mask_dir_path, scene)):
                ...
                # print(f"global_feat shape: before norm {global_feat.shape}")

                global_feat = torch.nn.functional.normalize(global_feat, dim=-1)
                FEAT_DIM = global_feat.shape[-1]

                # print(f"global_feat shape: after all comps {global_feat.shape}")
                ...
                for _i in range(num_masks):
                    ...
                    # print(f"roi otuput shape: {roifeat.shape}")
                    ...
                    # print("Global feat shape:", global_feat.shape)
                    # print("ROI feat shape:", roifeat.shape)
